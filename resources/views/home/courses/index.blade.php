...
@section('content')
            ...
            <div class="grid grid-cols-12 ">
                <div class="col-span-12  mr-4 my-4">
                    <div>
                        ...
                        <h1 class="text-main100 font-extrabold text-2xl sm:text-4xl text-center ">
    ...
    <div class="relative bottom-1 -z-10">
        <img class="w-full" src="/assets/home/wavestop.svg" alt="halazon hr">
    </div>

    @include('.home.generalComponents.getLead')
    ...
    <div class="container mx-auto">
        ...
        <section class="container border rounded-xl bg-gray-100 mx-auto px-4 py-8 mt-5">
            <div class=" mx-auto">

...
@endphp
    ...
    <button onclick="toggleSidebar()"class="p-4 bg-main50 text-white fixed top-4 left-4 z-50 md:hidden rounded-md focus:outline-none">
        <i class="fa-solid fa-bars"></i>
    </button>

    <aside id="sidebar"
           class="fixed border border-main50 sm:mt-3 w-64 h-full  sm:h-auto  bg-white shadow-xl transform translate-x-full md:translate-x-0 transition-transform duration-300 z-40 rounded-3xl">
        <div class="p-6">
...
<script>
    // جاوااسکریپت برای باز و بسته کردن سایدبار

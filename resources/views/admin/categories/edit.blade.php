        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    <h6>ویرایش دسته بندی {{$category->title}}</h6>
                    ...
                    <ol class="breadcrumb  mb-0 pb-0 pt-1 ps-2 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm active" aria-current="page">{{$category->title}}</li>
                    </ol>
                </div>
                            ...
                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 my-2">
                                                    ...
                                                    <input class="form-control" type="text" name="title" id="title"
                                                           value="{{old('title') ? old('title') : $category->title }}" placeholder="عنوان را وارد کنید.">
                                                </div>

                                                <div class="col-lg-6 my-2">
                                                    <label class="form-label" for="title_en">عنوان انگلیسی:</label>
                                                    <input class="form-control" type="text" name="title_en"
                                                           id="title_en" value="{{old('title_en') ? old('title_en') : $category->title_en }}"
                                                ...
                                                <div class="col-lg-6 my-2">
                                                    ...
                                                    <select class="form-control select2" name="parent_id" id="parent">
                                                        ...
                                                        @foreach(\App\Models\Category::all() as $categories)
                                                            <option {{$category->parent_id == $categories->id ? 'selected' : ''}} value="{{$categories->id}}">{{$categories->title}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-lg-6 my-2">
                                                    ...
                                                    <div class="input-group">
                                                       <span class="input-group-btn">
                                                        ...
                                                        <input id="thumbnail" class="form-control" type="text" name="image" value="{{old('image') ? old('image') : $category->image }}">
                                                    </div>
                                ...
                                <div class="col-lg-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="my-3">
                                                ...
                                                <textarea class="form-control" name="meta_description"
                                                          id="meta_description"
                                                          cols="30"
                                                          rows="3">{{old('meta_description') ? old('meta_description') : $category->meta_description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <button class="btn btn-success w-100" type="submit">بروز رسانی دسته بندی</button>
                                        </div>
                                    </div>
